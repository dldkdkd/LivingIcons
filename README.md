...
### LivingIcons
Animated Home Screen icons with GIF/APNG support, themes, per-app controls, Theme Studio, previews, compression, and notification badge support.

### LivingRespring
Choose any GIF for the iOS 17 respring animation. The Settings pane automatically optimizes the GIF into safe PNG frames before respringing.

### LivingIcons Dumper
Exports installed app icons and bundle identifiers to help create LivingIcons themes.

### DockPages
Adds multiple swipeable pages to the iPhone dock.

### Atria English Patch
Translates the RootHide/Relaxin build of Atria into English, including its Home Screen editor and preference resources.

**Maintainer:** Adam Never Lack
<!-- PACKAGE-LIST-END -->
